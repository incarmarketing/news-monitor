...
create table if not exists public.negative_watch_runs (
  ...
  minutes_back integer not null default 10,
...
create index if not exists idx_monitor_keywords_enabled_priority on public.monitor_keywords (enabled, category, priority, created_at);
