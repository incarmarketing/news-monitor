...
분류 기준:
- 긍정 기사는 {config.COMPANY_NAME}가 직접 언급되고, 당사 성과·수상·평판·우호 보도 맥락이 명확한 경우에만 인정하세요.
- {config.COMPANY_NAME}가 직접 언급되지 않은 기사는 절대 당사 긍정 기사로 쓰지 말고 업계/경쟁 동향으로만 해석하세요.
    ...
    return [
        {
            ...
            "articles": enrich_articles(select_evidence_articles(clustered, sections, limit=12)),
        },
        {
            "id": "own",
            "label": "당사 언급",
