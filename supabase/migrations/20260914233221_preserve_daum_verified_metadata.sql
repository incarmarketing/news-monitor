  ...
  if tg_op = 'UPDATE' and new.article_hash = old.article_hash
    ...
    if jsonb_typeof(v_evidence) = 'object'
       ...
       and (not public.media_portal_host(v_evidence->>'host') or (
         ...
         and ((v_evidence->>'method' = 'page_copyright' and v_evidence->'signals' @> '["daum_site_name","article_copyright"]'::jsonb)
          or (v_evidence->>'method' = 'page_metadata' and v_evidence->'signals' @> '["daum_site_name","daum_publisher_meta","daum_header"]'::jsonb))
       )) then
